...
with title_col:
    ...
    ">
        <div>
            ...
            <div style="color:rgba(255,255,255,0.60);font-size:11px;margin-top:4px;font-family:Arial,sans-serif;">
...
fig_g.add_trace(go.Indicator(
    ...
    gauge={
        ...
        "threshold": {"line": {"color": C_NAVY, "width": 2}, "thickness": 0.75, "value": float(stock_sold_pct)}
    },
...
fig_g.add_trace(go.Indicator(
    ...
    title={
        "text": "<b>Break Even</b><br><span style='font-size:11px;color:#7F8C8D;'>100% = break even</span>",
        "font": {"size": 13, "color": C_NAVY}
    },
    ...
    gauge={
        ...
        "threshold": {"line": {"color": C_GREEN, "width": 3}, "thickness": 0.75, "value": 100}
    },
